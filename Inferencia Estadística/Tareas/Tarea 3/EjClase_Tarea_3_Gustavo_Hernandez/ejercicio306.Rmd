...
w1 = dweibull(x, shape = b1, scale = a1**(-1/b1))
w2 = dweibull(x, shape = b2, scale = a2**(-1/b2))
w3 = dweibull(x, shape = b3, scale = a3**(-1/b3))
...
```{r}
datos$cw1 = 1 - pweibull(datos$w1, shape = b1, scale = a1**(-1/b1))
datos$cw2 = 1 - pweibull(datos$w2, shape = b2, scale = a2**(-1/b2))
datos$cw3 = 1 - pweibull(datos$w3, shape = b3, scale = a3**(-1/b3))
